...
public class Garagem {
        ...
        do {
            ...
            switch (option){
                case "1":
                    ...
                    programa(placa, placas, tempos, logsSaidas);
                    break;
                case "0":
                    System.exit(0);
                default:
    ...
    public static void programa(String placa, String placas[], LocalDateTime tempos[], String logsSaidas ) {
        ...
        if (posicao == -1) {
            ...
            saidaVeiculo(posicao,  placas, tempos, logsSaidas);
    ...
    private static void saidaVeiculo(int posicao, String placas[], LocalDateTime tempos[], String logsSaidas) {
